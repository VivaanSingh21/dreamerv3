...
"""Procedurally generated Swimmer domain, with a custom actuator gear scale
to make chains of 50-100+ links actuatable (stock dm_control's swimmer.xml
gear is tuned for the 3-6 link swimmer)."""
import collections
import os
...
def _make_model(n_bodies):
  ...
  swimmer_xml_path = os.path.join(_ASSETS_DIR, 'swimmer.xml')
